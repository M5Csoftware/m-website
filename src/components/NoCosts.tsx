      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-16 items-center">
        ...
        <div className="flex flex-col items-start gap-6 lg:pl-4">
          <p className="text-[13px] text-gray-500 font-medium leading-relaxed">
            We Believe In Value-Based Pricing. Our Rates Are Carefully
            Calculated Based On Destination, Shipment Weight, And Delivery
            Urgency—So You Only Pay For What Truly Matters. No Hidden Fees, No
            Surprise Surcharges, And No Unnecessary Overheads. Just Transparent
            Pricing Built Around Performance, Reliability, And Efficiency.
          </p>
          <Link href="/quote">
