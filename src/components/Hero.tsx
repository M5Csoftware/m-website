  ...
  return (
    <section className="max-w-425 w-full mx-auto px-4 sm:px-6 py-6 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="relative rounded-[28px] overflow-hidden min-h-110 bg-slate-700 flex flex-col justify-between">
          {/* Placeholder background */}
          <div className="absolute inset-0 bg-linear-to-br from-slate-800 via-slate-700 to-slate-600 z-0" />
          ...
          <div className="relative z-10 p-6 sm:p-8 lg:p-10 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6 sm:gap-0">
            ...
            <div className="w-17.5 h-17.5 sm:w-20 sm:h-20 relative flex items-center justify-center">
